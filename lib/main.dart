                ...
                BarChartData(
                  ...
                  gridData: FlGridData(
                    ...
                    getDrawingHorizontalLine: (value) {
                      if (value == 0) {
                        return FlLine(
                          color: Colors.black54, // X-axis line
                          strokeWidth: 1.2,
                        );
                      } else if (value == 5) {
                ...
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [
                          Color.fromARGB(255, 240, 236, 236), // green
                          Color.fromARGB(255, 240, 236, 236), // gray
          ...
          children: [
            ...
            isAlert == false
                ? Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex: 1, child: _statusText("20", "Active")),
                        const VerticalDivider(
                          color: Colors.black26,
                          thickness: 1,
                          width: 1,
                ...
                : Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          flex: 1,
                          child: _statusText("20", "Low Alert"),
                        ),
                        const VerticalDivider(
                          color: Colors.black26,
                          thickness: 1,
                        ...
                        Expanded(flex: 1, child: _statusText("101", "Medium")),
                        const VerticalDivider(
                          color: Colors.black26,
                          thickness: 1,
                          width: 1,
                        ...
                        Expanded(
                          flex: 1,
                          child: _statusText("12", "High Alert"),
                        ),
                      ],
                    ),
                  ),
